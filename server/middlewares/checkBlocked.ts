...
async function checkTeacherBlocked(req: Request, res: Response, next: NextFunction) {
    try {
...
async function checkStudentBlocked(req: Request, res: Response, next: NextFunction) {
    try {
