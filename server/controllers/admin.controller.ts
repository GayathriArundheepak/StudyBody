   ...
   async adminProfileUpdeate(req : Request , res : Response){
        ...
        console.log(req.body)
         const formData = req.body
            const response= await this.adminUsecase.adminProfileUpdeate(formData,id);
...
try{
 ...
 const userType:string=req.params.userType
  ...
  const response =await this.adminUsecase.blockUser(id,userType)
                  const statusCode =response.success? HttpStatus.success:HttpStatus.NotFound
...
try{
  ...
  const response =await this.adminUsecase.unblockUser(id,userType)
                  const statusCode =response.success? HttpStatus.success:HttpStatus.NotFound
...
try{
  ...
  const response =await this.adminUsecase.approveTeacher(id)
                  const statusCode =response.success? HttpStatus.success:HttpStatus.NotFound
...
try{
  ...
  const response =await this.adminUsecase.disApproveTeacher(id)
                  const statusCode =response.success? HttpStatus.success:HttpStatus.NotFound
