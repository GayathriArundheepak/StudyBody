...
class CourseController implements ICourseControllerInterface {
  ...
  constructor(_courseUsecase: CourseUsecase) {
    this._courseUsecase = _courseUsecase;
  }
  ...
  async createCourse(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.createCourse(courseData, id);
  ...
  async updateCourse(req: Request, res: Response): Promise<void> {
    try {
      ...
      const courseData = req.body; // Assuming the request body contains the course data
      console.log(courseData);
      const response = await this._courseUsecase.updateCourse(
        courseData,
        id,
        courseId
      );
  ...
  async getCourses(req: Request, res: Response): Promise<void> {
    try {
      const courseData = req.body; // Assuming the request body contains the course data
      console.log(courseData);
      const response = await this._courseUsecase.getCourses(courseData);
  ...
  async getCoursesByTeacher(req: Request, res: Response): Promise<void> {
    try {
      const id: string = req.params._id;
      const response = await this._courseUsecase.getCoursesByTeacher(id);
      console.log(response);
      const statusCode = response?.success
        ? HttpStatus.success
        : HttpStatus.NotFound;
  ...
  async getCoursesById(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.getCoursesById(courseId);
      console.log(response);
      const statusCode = response?.success
        ? HttpStatus.success
        : HttpStatus.NotFound;
  ...
  async searchCourse(req: Request, res: Response) {
    try {
      const searchData: string | undefined = req.query.query as
        | string
        | undefined;
      console.log(req.query);
      console.log(searchData);
      if (searchData !== undefined) {
        const response = await this._courseUsecase.searchCourse(searchData);
        const statusCode = response?.success
          ? HttpStatus.success
          : HttpStatus.NotFound;
  ...
  async filterCourse(req: Request, res: Response) {
    try {
      ...
      console.log(searchData);
      if (searchData !== undefined) {
        const response = await this._courseUsecase.filterCourse(searchData);
        const statusCode = response?.success
          ? HttpStatus.success
          : HttpStatus.NotFound;
  ...
  async deleteCourse(req: Request, res: Response): Promise<void> {
    try {
      ...
      const deletedCourse = await this._courseUsecase.deleteCourse(courseId);
  ...
  async updateCourseStudentsList(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.updateCourseStudentsList(
        courseId,
        studentId
      );
      const statusCode = response.success
  ...
  async createReview(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.createReview(
        courseId,
        ReviewData
      );
  ...
  async addMaterials(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.addMaterials(
        courseId,
        teacherId,
        materials
      );
  ...
  async getMaterials(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.getMaterials(courseId);
      const statusCode = response.success
        ? HttpStatus.success
        : HttpStatus.NotFound;
      res.status(statusCode).send({
  ...
  async approveCourse(req: Request, res: Response) {
    ...
    try {
      ...
      const response = await this._courseUsecase.approveCourse(id);
      const statusCode = response.success
        ? HttpStatus.success
        : HttpStatus.NotFound;
  ...
  async disApproveCourse(req: Request, res: Response) {
    ...
    try {
      ...
      const response = await this._courseUsecase.disApproveCourse(id);
      const statusCode = response.success
        ? HttpStatus.success
        : HttpStatus.NotFound;
  ...
  async addSubject(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.addSubject(
        syllabus,
        standard,
        subject
      );
  ...
  async getSubjects(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response = await this._courseUsecase.getSubjects(
        syllabus,
        standard
      );
      const statusCode = response.success
