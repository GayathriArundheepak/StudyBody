...
class CartController implements ICartControllerInterface {
  ...
  constructor(_cartUsecase: CartUsecase) {
    this._cartUsecase = _cartUsecase;
  }
  ...
  async addToCart(req: Request, res: Response) {
    try {
      ...
      const response = await this._cartUsecase.addToCart(studentId, courseId);
  ...
  async getCart(req: Request, res: Response) {
    try {
      ...
      const response = await this._cartUsecase.getCart(studentId);
  ...
  async removeFromCart(req: Request, res: Response) {
    try {
      ...
      const removedCourse = await this._cartUsecase.removeFromCart(
        studentId,
        courseId
      );
  ...
  async clearCart(req: Request, res: Response) {
    try {
      ...
      const response = await this._cartUsecase.clearCart(studentId);
