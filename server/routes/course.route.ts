...
courseRouter.post("/create-course/:_id", (req: Request, res: Response) => {
  courseController.createCourse(req, res);
});
courseRouter.put(
  "/update-course/:_id/:courseId",
...
courseRouter.get("/subjects/:syllabus/:standard", (req, res) =>
  courseController.getSubjects(req, res)
);

courseRouter.get("/search-course", (req: Request, res: Response) => {
  courseController.searchCourse(req, res);
});
courseRouter.get("/filter-course", (req: Request, res: Response) => {
  courseController.filterCourse(req, res);
});

courseRouter.put("/approve-course/:_id", (req: Request, res: Response) => {
  courseController.approveCourse(req, res);
});
courseRouter.put("/disApprove-course/:_id", (req: Request, res: Response) => {
  courseController.disApproveCourse(req, res);
});
