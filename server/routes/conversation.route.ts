...
conversationRouter.post("/", (req: Request, res: Response) => { conversationController.createNewConversation(req,res) });
conversationRouter.get("/:userId", (req: Request, res: Response) => { conversationController.getConversationsByUserId(req,res) });
conversationRouter.get("/find/:firstUserId/:secondUserId", (req: Request, res: Response) => { conversationController.findConversationByUserIds(req,res) });
