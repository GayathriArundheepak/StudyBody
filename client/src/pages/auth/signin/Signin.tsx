...
const Signin: React.FC = () => {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>): void => {
    ...
    try{
      ...
      api.post<ApiResponse>("/api/auth/login", formData, { withCredentials: true })
    ...
    <div className='signin'>
      ...
      <ToastContainer />
        ...
        <form action="POST" onSubmit={handleSubmit} >
          ...
          <button className='auth-btn' type='submit'>Signin</button>
          <Link to={`/forgotPassword?email=${formData.email}`}>Forgot Password?</Link>
          <Link to="/signup">
