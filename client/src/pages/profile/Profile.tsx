...
const Profile: React.FC = () => {
  ...
  const handleSubmit = async (values: { username: string; password: string; gender: string; date_of_birth: string | Date; }, actions: FormikHelpers<{ username: string; password: string; gender: string; date_of_birth: string | Date; }>) => {
    ...
    try {
      ...
      api.put(`/api/${userType}/updateProfile/${id}`, updatedValues, {
          ...
          >
            {({ isSubmitting }) => (
              <Form>
                ...
                <button type='submit' disabled={isSubmitting}>Save change</button>
              </Form>
            )}
          </Formik>
        </div>
