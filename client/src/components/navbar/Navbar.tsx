...
import { fetchCoursesStart, fetchCoursesSuccess } from '../../redux/course/CourseSlice'; // Import the fetchCoursesStart action
...
const Navbar: React.FC = () => {
  ...
  const profilePicSrc = currentUser?.profilePic ? currentUser.profilePic : 'default-profile-pic-url';
  ...
  return (
    <div className={`navbar ${sidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className={`sidebar  ${sidebarOpen ? 'sidebar-open' : ''}`}>
        <button className="sidebar-toggle menuIcon" onClick={handleToggleSidebar}>
      ...
      <ul className="nav-links">
        <li className='home-link'><Link to="/">Home</Link>
        </li>
        {userType === 'student' && <li><Link to="/courses">Courses</Link></li>}
        <li><Link to="/about">About</Link></li>
        {isLoggedIn && userType === 'student' && (
          <>
            <li><Link to="/mylearnings"><AutoStoriesIcon/></Link></li>
            <li><Link to="/cart"><ShoppingCartOutlined/></Link></li>
            <li><Link to="/wishlist"><FavoriteSharpIcon/></Link></li>
          </>
        )}
        {!isLoggedIn && (
          <>
        ...
        {isLoggedIn && (
          <li>
            <Link to={profileLink}>
              <img className='profile-pic' src={profilePicSrc} alt="Profile pic"/>
            </Link>
          </li>
        )}
      </ul>
