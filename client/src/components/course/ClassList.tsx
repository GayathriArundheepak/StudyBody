    ...
    const classes: { standard: ClassStandard, description: string }[] = [
        {
            ...
            description: 'One hour live class / 16x Lesson / Test Papers / Free Study Materials'
        },
        {
                ...
                {classes.map((classItem, index) => (
                    <div key={index} className="card">
                        ...
                        <div className="class-details">
                            <h3>{classItem.standard}({selectedSyllabus})</h3>
                            <p>{classItem.description}</p>
                            <button className='btn' onClick={() => handleClickSubjects(classItem.standard)} 
                            disabled={loading}
                            >
